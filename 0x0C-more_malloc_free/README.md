...
main.h Prototype: void *malloc_checked(unsigned int b);
main.h Returns a pointer to the allocated memory
main.h if malloc fails, the malloc_checked function should cause normal process termination with a status value of 98
